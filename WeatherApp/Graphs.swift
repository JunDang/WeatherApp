...
//        xAxis.spaceBetweenLabels = 0.0
    ...
    func updateDailyData(dailyForecastsData : [DailyForecast]) {
        ...
        let highTemperatureSet = LineChartDataSet(yVals: dataEntriesHighTemperature, label: "daily Temperature High")
        ...
        let lowTemperatureSet = LineChartDataSet(yVals: dataEntriesLowTemperature, label: "daily Temperature Low")
